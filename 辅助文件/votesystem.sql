...
CREATE TABLE IF NOT EXISTS `activitys` (
  ...
  `vv` int(9) NOT NULL DEFAULT '0' COMMENT '总共访问次数',
...
CREATE TABLE IF NOT EXISTS `alluser` (
  ...
  `detail` text NOT NULL COMMENT '详细json信息',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `candidate` (
  ...
  `name` varchar(140) CHARACTER SET utf8 NOT NULL COMMENT '名称',
  ...
  `imgurl` text CHARACTER SET utf8 NOT NULL COMMENT '图片路径',
...
CREATE TABLE IF NOT EXISTS `record` (
  ...
  `towho` varchar(128) NOT NULL COMMENT '投票对象',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6273 ;
...
CREATE TABLE IF NOT EXISTS `voter` (
  ...
  `belong` varchar(128) NOT NULL COMMENT '所属活动',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='投票人信息例表' AUTO_INCREMENT=9 ;
