...
if (!isset($candidate_name) || !isset($candidate_type) || !isset($candidate_intro) || !isset($candidate_contact)) {
    ...
    if ($ac->changeCandidate($candidate_name, $candidate_contact, $candidate_key, $candidate_intro, $candidate_type, $activity_key, $candidate_media, $imgJson)) {
        $array = array('code' => 0,
                       'msg'  => $candidate_key );
        echo json_encode($array, JSON_UNESCAPED_UNICODE);
    }else{
