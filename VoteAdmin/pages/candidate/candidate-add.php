...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $ac_name; ?>
        <small>在此添加活动候选人</small>
        <input type="hidden" id="activity-key" value="<?php echo $ackey; ?>"></input>
        <input type="hidden" id="upload-status" value=""></input>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="#"><i class="fa fa-circle-o text-yellow"></i> 添加候选人</a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form role="form">
                ...
                <div class="form-group" id="candidate-name">
                  <label>姓名</label>
                  <input type="text" class="form-control" placeholder="请输入候选人姓名" id="candidate-name-input" max="50" maxlength="50">
                  <span class="help-block" id="candidate-name-error"></span>
                </div>
                <div class="form-group" id="candidate-contact">
                  <label>联系方式（QQ或TEL）</label>
                  <input type="text" class="form-control" placeholder="请输入联系方式" id="candidate-contact-input" maxlength="50" max="50">
                  <span class="help-block" id="candidate-contact-error"></span>
                </div>
                <div class="form-group" id="candidate-key">
                  <label>编号</label>
                  <input type="text" class="form-control" placeholder="请输入编号，不填写则随机" id="candidate-key-input" max="25" maxlength="25">
                  <span class="help-block" id="candidate-key-error"></span>
                </div>
                <!-- textarea -->
                <div class="form-group" id="candidate-intro">
                  <label>简介（500字以内）</label>
                  <textarea class="form-control" rows="3" placeholder="请在此输入简介" id="candidate-intro-input"></textarea>
                ...
                <div class="mailbox-attachment-info candidate-img-footer">
                  ...
                  <label class="btn btn-default" for="candidate-img-input">选择图片</label>
                ...
                <div class="box-footer" id="candidate-video-footer">
                  <div class="form-group" id="candidate-video">
                    <label>参选视频</label>
                    <input type="text" class="form-control" placeholder="请把视频上传至腾讯视频，然后复制视频链接粘贴至此" id="candidate-video-input">
                ...
                <div class="box-footer" id="candidate-link-footer">
                    <div class="form-group" id="candidate-link">
                      <label>外链链接</label>
                      <input type="text" class="form-control" placeholder="请复制外链粘贴链接至此" id="candidate-link-input">
                  ...
                  <ul class="mailbox-attachments clearfix pull-left">
                    <li style="overflow:hidden;">
                      ...
                      <div id="candidate-link-img"><span class="mailbox-attachment-icon has-img"><img src="../../dist/img/back.jpg" alt="Attachment"></span></div>
                  ...
                  <ul class="mailbox-attachments clearfix pull-left">
                    <li style="overflow:hidden; width: auto;">
                      <div class="mailbox-attachment-info">
                        ...
                        <div id="candidate-audio"><audio controls="controls"><source src="" type="audio/mp3" ></audio></div>
            ...
            <div class="box-footer">
              <div type="submit" class="btn btn-primary pull-right" id="candidate-add-upload">确认添加</div>
